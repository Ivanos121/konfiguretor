...
#include <memory>
#include "../../Видео/com_port/untitled/header.h"
...
void Header::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onCheckedV((*reinterpret_cast< const QVector<bool>(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->onChecked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Header::*)(const QVector<bool> & , int );
...
// SIGNAL 0
void Header::onCheckedV(const QVector<bool> & _t1, int _t2)
{
...
// SIGNAL 1
void Header::onChecked(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
