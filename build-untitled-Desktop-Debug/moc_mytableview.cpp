...
#include <memory>
#include "../untitled/mytableview.h"
...
QT_MOC_LITERAL(1, 12, 10), // "mouseHover"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "QModelIndex"
QT_MOC_LITERAL(4, 36, 5) // "index"

    },
    "MyTableView\0mouseHover\0\0QModelIndex\0"
    "index"
};
...
void MyTableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseHover((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyTableView::*)(QModelIndex );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTableView::mouseHover)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTableView::mouseHover(QModelIndex _t1)
{
